...
def test_initialize_watsonxllm_with_project_id_from_env(
...
def test_initialize_watsonxllm_with_space_id_from_env(
    mocker: Any, monkeypatch: pytest.MonkeyPatch
) -> None:
...
def test_initialize_watsonxllm_with_both_ids_from_env(
    mocker: Any, monkeypatch: pytest.MonkeyPatch
) -> None:
...
def test_initialize_watsonxllm_explicit_project_id_overrides_env(
    mocker: Any, monkeypatch: pytest.MonkeyPatch
) -> None:
...
def test_initialize_watsonxllm_explicit_space_id_overrides_env(
    mocker: Any, monkeypatch: pytest.MonkeyPatch
) -> None:
