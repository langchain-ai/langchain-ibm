...
def test_initialize_chat_watsonx_with_project_id_from_env(
    ...
    assert chat.project_id == test_project_id


def test_initialize_chat_watsonx_with_space_id_from_env(
    mocker: Any, monkeypatch: pytest.MonkeyPatch
) -> None:
    ...
    assert chat.space_id == test_space_id


def test_initialize_chat_watsonx_with_both_ids_from_env(
    mocker: Any, monkeypatch: pytest.MonkeyPatch
) -> None:
...
def test_initialize_chat_watsonx_explicit_project_id_overrides_env(
    mocker: Any, monkeypatch: pytest.MonkeyPatch
) -> None:
    ...
    assert chat.project_id == explicit_project_id


def test_initialize_chat_watsonx_explicit_space_id_overrides_env(
    mocker: Any, monkeypatch: pytest.MonkeyPatch
) -> None:
